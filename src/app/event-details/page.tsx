...
import EventDetailsCard from '../../components/ui/EventDetailsCard';
...
const EventDetailsPage = () => {
    ...
    const eventDetails = {
        ...
        "Codelicious": {
            ...
            rounds: "Round 1: This event comprises of a single round. It is an online contest hosted on Codechef",
            teamDistribution: "Only individual participation is allowed",
            eventLeads: [
        ...
        "Compute and Compete": {
            ...
            rounds: "Round 1 -Reverse Coding: Candidates will be given 6-7 questions to solve and it will be conducted on Hackerrank online.\nRound 2- Bug-Off: Particpants will be given code snippets to debug.",
