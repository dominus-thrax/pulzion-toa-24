...
const TimelinePage: React.FC = () => {
  ...
  return (
    <div>
      {/* Section 1: Custom Event Timeline */}
        ...
        <div className="flex justify-center space-x-[32rem] items-center text-green-300">
          ...
          <div className="flex items-center">
            <div className="font-VT323 text-[54px] text-yellow-300 mb-4 mr-32">
              <div>T</div><div>E</div><div>C</div><div>H</div><div>N</div><div>I</div><div>C</div><div>A</div><div>L</div>
            </div>
            <div>
              <img
            ...
            <div className="flex flex-col space-y-24">
              {events.map((event, index) => (
                <button key={index} onClick={() => router.push(event.path)}>
          ...
          <div className="flex items-center">
            ...
            <div className="font-VT323 text-[50px] text-yellow-300 mb-4 ml-32">
              <div>N</div><div>O</div><div>N</div><div>T</div><div>E</div><div>C</div><div>H</div><div>N</div><div>I</div><div>C</div><div>A</div><div>L</div>
            </div>
          </div>
        </div>
      </div>
