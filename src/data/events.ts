export const eventDetails = {
  ...
  "web-n-app": {
    ...
    rounds:
      "Round 1: PPT Submission The team can pick any one problem statement of their choice and work on the same. Participants will have to submit a ppt for the same. The judgment for this round will be on the basis of the following factors: - The originality and uniqueness of the idea. - Appropriateness and effectiveness of the chosen technologies and frameworks. - Clarity and functionality of the solution.\nRound 2 : Hackathon The selected teams from Round 1 will be asked to show the working web or app . The judgment of this round will be based on the following factors: -Maximum end-to-end implementation of the live/on-spot changes of features as directed by the judges of the event. -Time execution, cleaner code and seamless working model/prototype of the application is desired. -Frontend application(UI/UX) implementation. - Extra points will be given to ML/Blockchain/AR-VR implementation and business potential -This is final round and will be of 7-8 hours",
    teamDistribution:
    ...
    timeline:
      "Round 1:- Submission Timeline:- 27th September 12:00 am - 1st October 6:00 pm (Online)\nRound 2: 4th October 9:00 am Onwards.Problem Statements will be released soon\n",
  },
  electroquest: {
    id: 4,
    mode: "Offline",
